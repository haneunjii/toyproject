...
export class updateSocialsTable1676218039862 implements MigrationInterface {
  name = 'updateSocialsTable1676218039862';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            CREATE TYPE "public"."oauth_types_sns_type_enum" AS ENUM('KAKAO', 'NAVER', 'GOOGLE', 'ETC')
        `);
    await queryRunner.query(`
            CREATE TABLE "oauth_types" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "username" character varying NOT NULL,
                "sns_type" "public"."oauth_types_sns_type_enum" NOT NULL,
                "user_sns_id" uuid,
                CONSTRAINT "UQ_2b8ea278aeb12fc181a08c62b0b" UNIQUE ("username"),
                CONSTRAINT "PK_f8cb26f0be54d34b74e551738df" PRIMARY KEY ("id", "sns_type")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "oauth_types"
            ADD CONSTRAINT "FK_aa33b2cc707b54125a7c9047ba8" FOREIGN KEY ("user_sns_id") REFERENCES "user_sns"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
            ALTER TABLE "users"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "oauth_types" DROP CONSTRAINT "FK_aa33b2cc707b54125a7c9047ba8"
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            DROP TABLE "oauth_types"
        `);
    await queryRunner.query(`
            DROP TYPE "public"."oauth_types_sns_type_enum"
        `);
    await queryRunner.query(`
